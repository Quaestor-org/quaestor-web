import { fetchOutcomes, fetchLessonData } from '@/lib/dal';
...
export default async function OutcomesPage() {
  ...
  const pendingSummaries = sortedOutcomes.some(o => o.aiSummary === null);

  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      {pendingSummaries && <AutoRefresh />}
      <h1 className="text-3xl font-bold tracking-tight text-zinc-900">Your Learning Outcomes</h1>
      
      {sortedOutcomes.length === 0 ? (
        <p className="text-zinc-500">You haven't completed any lessons yet. Head over to the Courses page to start learning!</p>
      ) : (
